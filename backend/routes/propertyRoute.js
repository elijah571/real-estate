...
// Property routes
propertyRoute.post('/create', auth, authAdmin, createProperty); // Create a new property
propertyRoute.put('/update/:id', auth, authAdmin, updateProperty); // Update a specific property by ID
